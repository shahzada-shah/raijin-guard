    ...
    <section id="core-benefits" className="relative z-10 py-20 bg-zinc-950 min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-900/30 border border-gray-800/50 rounded-2xl p-8 hover:bg-gray-900/50 transition-all duration-300">
            <div className="mb-8 flex justify-center">
              <div className="relative w-48 h-48">
                ...
                <div className="absolute inset-4 rounded-full border border-gray-700/40"></div>
                <div className="absolute inset-8 rounded-full border border-gray-700/50"></div>
                <div className="absolute inset-12 rounded-full border border-gray-700/60"></div>
            ...
            <div className="flex items-center mb-4">
              <div className="w-6 h-0.5 bg-lime-400 mr-3"></div>
          ...
          <div className="bg-gray-900/50 border border-gray-700/70 rounded-2xl p-8 hover:bg-gray-900/70 transition-all duration-300">
            <div className="mb-8 flex justify-center">
              <div className="relative w-48 h-48">
                {/* Outer rings - more prominent for highlighted card */}
                <div className="absolute inset-0 rounded-full border border-gray-600/40"></div>
                <div className="absolute inset-4 rounded-full border border-gray-600/50"></div>
                <div className="absolute inset-8 rounded-full border border-gray-600/60"></div>
                <div className="absolute inset-12 rounded-full border border-gray-600/70"></div>

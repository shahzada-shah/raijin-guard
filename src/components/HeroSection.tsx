        ...
        <div className="text-center pt-40 pb-16 min-h-screen flex flex-col justify-center">
          ...
          <div className="border-t border-gray-700/50 pt-10">
            <div className="flex items-center justify-center mb-5">
              ...
              <p className="text-[10px] md:text-[11px] text-gray-400 uppercase tracking-[0.2em] font-semibold">
            ...
            <div className="flex items-center justify-center gap-8 md:gap-12 opacity-40">
              <div className="text-gray-300 font-bold text-sm md:text-base tracking-wider">JAVASCRIPT</div>
              <div className="text-gray-300 font-bold text-sm md:text-base tracking-wider">PYTHON</div>
              <div className="text-gray-300 font-bold text-sm md:text-base tracking-wider">TYPESCRIPT</div>
              <div className="text-gray-300 font-bold text-sm md:text-base tracking-wider">JAVA</div>
              <div className="text-gray-300 font-bold text-sm md:text-base tracking-wider">GO</div>
              <div className="text-gray-300 font-bold text-sm md:text-base tracking-wider">RUST</div>
            </div>
          </div>
        </div>
      </div>

    ...
    <div className="min-h-screen bg-gray-950 flex">
      ...
      <div className="hidden lg:block relative w-1/2">
        ...
        <img
          ...
          alt="Security professional working on code"
        />
        ...
        <div className="absolute bottom-8 left-8 right-8">
          <div className="flex space-x-2 mb-4">
            <div className="w-8 h-1 bg-lime-400 rounded"></div>
            <div className="w-8 h-1 bg-gray-600 rounded"></div>
            <div className="w-8 h-1 bg-gray-600 rounded"></div>
          </div>
          <blockquote className="text-white text-lg font-medium leading-relaxed">
            "A secure development environment where code quality meets enterprise-grade protection, creating a foundation for reliable and trustworthy software."
          </blockquote>
        </div>
      </div>
    </div>

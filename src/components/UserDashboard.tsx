    ...
    <div className="min-h-screen bg-neutral-950 flex">
      ...
      >
          ...
          <div className="p-4 border-b border-neutral-800">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search"
                className="w-full bg-neutral-800 text-white pl-10 pr-4 py-2 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-white focus:bg-neutral-700 transition-colors"
              />
            </div>
          </div>
        )}
        ...
        {showNotification && !isCollapsed && (
          <div className="m-3 bg-gradient-to-r from-white/10 to-neutral-500/10 border border-white/20 rounded-lg p-4 relative transition-opacity duration-300">
            <button
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                ...
                <div className="text-neutral-400 text-xs">Advanced AI scanning</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-neutral-400 text-xs">security@securecode.com</div>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6">
          <div className="mb-8">
            ...
            <p className="text-neutral-400">Monitor your repository security and manage your projects.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-lg p-6">
              ...
              <p className="text-neutral-400 text-sm">Active security monitoring</p>
            </div>
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-lg p-6">
              ...
              <p className="text-neutral-400 text-sm">Require immediate attention</p>
            </div>
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-lg p-6">
              ...
              <p className="text-neutral-400 text-sm">Collaborating on security</p>
            </div>
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-lg p-6">
              ...
              <p className="text-neutral-400 text-sm">Overall repository health</p>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between py-3 border-b border-neutral-800 last:border-b-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-400 text-sm">SQL injection vulnerability in user authentication</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between py-3 border-b border-neutral-800 last:border-b-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-400 text-sm">No critical issues found, 2 minor warnings</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between py-3 border-b border-neutral-800 last:border-b-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-400 text-sm">Sarah Johnson joined the security team</p>
                  </div>
                </div>
